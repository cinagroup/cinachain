...
export const en: Record<string, string> = {
  ...
  "home.heroDescription":
    "A Web3 collection platform on Base — mint, trade, and build with NFTs, badges, and credits.",
  ...
  "keys.description": "Register and manage API keys for the CinaChain billing system.",
