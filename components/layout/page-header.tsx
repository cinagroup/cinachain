...
function PageHeaderHeading({
  ...
  return (
    <motion.h1
      ...
      className={cn(
        "font-display bg-gradient-to-br from-black to-stone-500 bg-clip-text text-center text-4xl leading-tight tracking-tight text-transparent drop-shadow-sm dark:from-stone-100 dark:to-yellow-200 md:text-8xl md:leading-[6rem] lg:leading-[1.1]",
        className
      )}
      {...props}
    >
